<html>
    ...
    <body bgcolor="#FFFFFF" text="#000000">
                        ...
                        <table width="100%" border="5" align="center" cellspacing="0" cellpadding="3">
                            ...
                            while ($row = mysql_fetch_array($result)) {
                                ...
                                if ($pro = mysql_fetch_array($proresult)) {
                                    ...
                                    echo "    <td> ";
                                    echo "      <center> ";
                                    echo "       <input type=\"checkbox\" name=\"remove[" . $pro["productid"] . "]\" value=\"1\">Remove ";
                                    echo "      </center>";
                                    echo "    </td>";
                                    echo " </tr>";
                                    $carttotal+=$pro["price"];
        ...
        <?php
        echo "    <center><a href=\"confirmorder.php?customerid=" . $customerid . "&category=" . $category . "&total=" . $carttotal . "\"><h2>Confirm Order</a></h2></center>";
        ?>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
    </body>
